...
export default function About(): JSX.Element {
  ...
  return (
    <div className={`flex flex-col gap-10 items-center w-full z-30 text-white pt-10`} >
      <div className="flex flex-col md:flex-row items-start gap-10 w-full">
        <div className="bg-secondary rounded-[2rem] sticky gap-5 flex flex-col md:w-1/2 p-7">
