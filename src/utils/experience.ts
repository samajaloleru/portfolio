export const  experienceList = [
    ...
    },
    {
        ...
        year: "2021 -2023",
        role: "Senior Software Engineer",
        description: "Spearheaded the development of the company's ride-hailing platform by designing and maintaining critical features such as driver-rider matching, real-time location tracking, in-app payments, and route optimization, implementing a microservices architecture to improve scalability and system reliability, automating CI/CD pipelines to accelerate deployment and reduce manual effort, and mentoring junior developers on best practices in code reviews, design patterns, and debugging techniques."
    },
    {
        company: "Essential Software Company",
        year: "2016 - 2021",
        role: "Software Engineer",
        description: "Designed and developed a customer relationship management (CRM) system with features including contact management, lead tracking, opportunity management, and sales forecasting, implemented a RESTful API to integrate seamlessly with marketing automation and e-commerce platforms, and enforced data accuracy through validation rules, cleansing routines, and quality checks."
    },
]